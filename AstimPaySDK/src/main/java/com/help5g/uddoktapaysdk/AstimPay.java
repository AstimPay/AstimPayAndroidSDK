package com.help5g.astimpaysdk;
...
public class AstimPay {
    ...
    public AstimPay(WebView webView, PaymentCallback callback) {
...
//                verifyPayment(webView.getContext(), invoiceId);
                ...
                if (response.isSuccessful()) {
                    ...
                    try {
                        ...
                        if ("COMPLETED".equals(status)) {
                            ...
                            Log.d("AstimPayDebug", "Extracted Metadata: " + metadataValues.toString());
    ...
    private Map<String, String> extractMetadata(JSONObject jsonObject) {
        ...
        Log.d("AstimPayDebug", "Raw JSON: " + jsonObject.toString());

        if (metadataObject != null) {
            Log.d("AstimPayDebug", "Metadata Object: " + metadataObject.toString());
